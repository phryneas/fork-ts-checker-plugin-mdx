...
import { FilesRegister } from 'fork-ts-checker-webpack-plugin/lib/FilesRegister'; // import for types alone
// tslint:disable-next-line:no-implicit-dependencies no-submodule-imports
import { FilesWatcher } from 'fork-ts-checker-webpack-plugin/lib/FilesWatcher'; // import for types alone
